...
/*
        oReadResp = toNative(oFileService.upload({
            ...
            "nodeType": item.nodeType,
            "sourcePath": "https://raw.githubusercontent.com/JelasticJPS/optimizeConfigs/master/scripts/script_prev.sh"
        }));
*/
        ...
        oReadResp = toNative(oFileService.upload({
            "destPath": "/var/lib/jelastic/keys/installScript.sh",
            "nodeType": item.nodeType,
            "sourcePath": "https://raw.githubusercontent.com/JelasticJPS/optimizeConfigs/master/scripts/script.sh"
        }));
